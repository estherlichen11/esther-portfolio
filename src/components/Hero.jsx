    ...
    <section className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <motion.p
          ...
          className="text-violet-400 font-medium mb-4 tracking-widest text-sm uppercase"
        >
          Hi, I'm Esther
        </motion.p>
        ...
        >
          ...
          <a
            href="#contact"
            className="px-6 py-3 border border-neutral-700 hover:border-neutral-500 text-neutral-300 hover:text-white rounded-full font-medium transition-colors"
          >
            Get in touch
          </a>
        </motion.div>
