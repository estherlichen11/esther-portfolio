  ...
  return (
    <section id="about" className="py-24 px-6">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <FadeIn delay={0.2}>
          <h3 className="text-neutral-300 font-semibold mb-4 uppercase tracking-widest text-sm">Skills</h3>
          <div className="flex flex-wrap gap-2">
            {skills.map((skill) => (
              <span
                key={skill}
                className="px-3 py-1.5 bg-neutral-900 border border-neutral-800 text-neutral-300 rounded-full text-sm hover:border-violet-500 hover:text-violet-300 transition-colors"
              >
                {skill}
              </span>
            ))}
